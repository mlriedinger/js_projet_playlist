...
$(document).ready(function(){
  ...
  $.get('./playlist.txt', function(data){         // Récupère la liste dans le fichier txt
    ...
    listOfMovie.forEach(element => {$('#list').append(htmlDivElement(element));              // Affiche chaque élément du tableau listOfMovie dans une <div> avec son index, nom et durée
